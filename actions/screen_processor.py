...
from memory.config_manager import get_voice_language, get_voice_name
...
class _VisionSession:
    ...
    async def _session_loop(self) -> None:
        ...
        if voice_name and voice_name.strip().lower() == "aditi":
            print("[Vision] WARNING: Voice 'Aditi' is not supported by this model; falling back to default voice config.")
            voice_name = None
        print(f"[Vision] Voice config: voice_name={voice_name}")
        ...
        if voice_name:
            config_kwargs['speech_config'] = gtypes.SpeechConfig(
