    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "topic": {"type": "STRING", "description": "Topic to monitor or stop monitoring (e.g. 'space exploration', 'AI news')"},
            },
            "required": ["action"],
        },
    },
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "instruction": {"type": "STRING", "description": "Free-form instruction if action doesn't cover it. E.g. 'translate this to Turkish', 'find all email addresses'"},
